    ...
    <header className="flex flex-col md:flex-row items-start md:items-center justify-between fixed top-0 left-0 w-full bg-[#1A1717] shadow-xl/20 px-4 py-3 sm:px-5 md:px-8 lg:px-10 z-50">
      ...
      {isOpen && (
        <div className="md:hidden mt-3 space-y-2 w-full">
          ...
          <NavLink to="/about" onClick={() => setIsOpen(false)} className={({ isActive }) => `h-12 w-full text-[14px] px-4 flex items-center rounded ${isActive ? 'text-[#33FFC2] bg-[rgba(61,79,61,0.7)]' : 'text-white hover:text-[#33FFC2] hover:bg-[rgba(61,79,61,0.7)]'}`}>
            About Us
          </NavLink>
          ...
          <NavLink to="/project" onClick={() => setIsOpen(false)} className={({ isActive }) => `h-12 w-full text-[14px] px-4 flex items-center rounded ${isActive ? 'text-[#33FFC2] bg-[rgba(61,79,61,0.7)]' : 'text-white hover:text-[#33FFC2] hover:bg-[rgba(61,79,61,0.7)]'}`}>
            Projects
          </NavLink>
          <NavLink to="/contact" onClick={() => setIsOpen(false)} className={({ isActive }) => `h-12 w-full text-[14px] px-4 flex items-center rounded ${isActive ? 'text-[#33FFC2] bg-[rgba(61,79,61,0.7)]' : 'text-white hover:text-[#33FFC2] hover:bg-[rgba(61,79,61,0.7)]'}`}>
            Contact Us
          </NavLink>
        </div>
      )}
